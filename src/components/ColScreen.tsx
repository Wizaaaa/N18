...
export default function ColScreen(props: {
  ptoho1: string
  ptoho2: string
  ptoho3: string
  ptoho4: string
      ...
      <div className="frame10 flex flex-col items-start max-w-7xl">
        ...
        <div className="frame9 flex items-center justify-start gap-5">
          <div className="flex items-center gap-5">
            ...
            <img src={props.ptoho2} alt="photo" className="w-65 object-cover rounded-4xl shadow-xl" loading="eager"/>
          </div>

          <div className="flex items-center gap-5">
            <img src={props.ptoho3} alt="photo" className="w-65  object-cover rounded-4xl shadow-xl" loading="eager"/>
            <img src={props.ptoho4} alt="photo" className="w-78.75 object-cover rounded-4xl shadow-xl" loading="eager"/>
          </div>
        </div>
      </div>
